import {
  Portal_default
} from "./chunk-GTU4MR3F.js";
import {
  useThemeProps
} from "./chunk-C7XY23JW.js";
import {
  Typography_default
} from "./chunk-4FVOJZN5.js";
import {
...
import "./chunk-XWB22SYX.js";
import "./chunk-TXQLOUD6.js";
import "./chunk-74FMSX72.js";
import {
  useDefaultProps
} from "./chunk-WB3IZD62.js";
import {
  HTMLElementType,
  _extends,
  chainPropTypes,
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(AppearingMask, {
    ...
    children: transitionChange((style, interpolator) => (0, import_jsx_runtime9.jsx)(AreaElementPath, _extends({}, other, {
      ownerState,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(AppearingMask, {
    ...
    children: transitionChange((style, interpolator) => (0, import_jsx_runtime16.jsx)(LineElementPath, _extends({}, other, {
      ownerState,
      d: style.value.to(interpolator)
    })))
  });
...
var Popper3 = React61.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(React62.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React63.useState(null);
  React63.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime32.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime32.jsx)("tbody", {
        children: (0, import_jsx_runtime32.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime32.jsx)(ChartsTooltipCell, {
            className: clsx_default(classes.markCell, classes.cell),
            children: (0, import_jsx_runtime32.jsx)(ChartsTooltipMark, {
              color: color2,
              className: classes.mark
            })
          }), (0, import_jsx_runtime32.jsx)(ChartsTooltipCell, {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types22.default.func.isRequired,
  /**
   * The data used to identify the triggered item.
   */
  itemData: import_prop_types22.default.shape({
    ...
    type: import_prop_types22.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React65.useContext(ZAxisContext);
  ...
  return (0, import_jsx_runtime33.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime34.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime34.jsx)("thead", {
        children: (0, import_jsx_runtime34.jsx)(ChartsTooltipRow, {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime34.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime34.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color2 && (0, import_jsx_runtime34.jsx)(ChartsTooltipMark, {
                color: color2,
                className: classes.mark
              })
            }), (0, import_jsx_runtime34.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime34.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types23.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types23.default.shape({
    x: import_prop_types23.default.shape({
      index: import_prop_types23.default.number,
      value: import_prop_types23.default.oneOfType([import_prop_types23.default.instanceOf(Date), import_prop_types23.default.number, import_prop_types23.default.string]).isRequired
    }),
    y: import_prop_types23.default.shape({
      index: import_prop_types23.default.number,
      value: import_prop_types23.default.oneOfType([import_prop_types23.default.instanceOf(Date), import_prop_types23.default.number, import_prop_types23.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types23.default.oneOfType([import_prop_types23.default.instanceOf(Date), import_prop_types23.default.number, import_prop_types23.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React67.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React67.useMemo(() => {
  ...
  return (0, import_jsx_runtime35.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime36.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime36.jsx)(PopperComponent, _extends({}, popperProps, {
      className: classes.root,
      children: trigger === "item" ? (0, import_jsx_runtime36.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime36.jsx)(ChartsAxisTooltipContent, {
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime37.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime37.jsx)("rect", {
    ...
    }), (0, import_jsx_runtime37.jsx)(ChartsText, {
      style: _extends({
        pointerEvents: "none"
      }, labelStyle),
      text: label,
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React72.useMemo(
  ...
  const padding = React72.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React72.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React72.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React72.useMemo(() => {
  ...
  return (0, import_jsx_runtime38.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime38.jsx)(ChartsLegendRoot, {
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  drawingArea: import_prop_types25.default.shape({
    bottom: import_prop_types25.default.number.isRequired,
    height: import_prop_types25.default.number.isRequired,
    left: import_prop_types25.default.number.isRequired,
    right: import_prop_types25.default.number.isRequired,
  ...
  series: import_prop_types25.default.object.isRequired,
  seriesToDisplay: import_prop_types25.default.arrayOf(import_prop_types25.default.shape({
    ...
    itemId: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.string]),
    label: import_prop_types25.default.string.isRequired,
    maxValue: import_prop_types25.default.oneOfType([import_prop_types25.default.instanceOf(Date), import_prop_types25.default.number]),
    minValue: import_prop_types25.default.oneOfType([import_prop_types25.default.instanceOf(Date), import_prop_types25.default.number]),
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime40.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React75.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime41.jsxs)(React76.Fragment, {
    children: [(0, import_jsx_runtime41.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime41.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types27.default.oneOf(["end", "middle", "start"]),
  /**
   * The axis direction containing the color configuration to represent.
   * @default 'z'
   */
  axisDirection: import_prop_types27.default.oneOf(["x", "y", "z"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types27.default.oneOfType([import_prop_types27.default.number, import_prop_types27.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types27.default.oneOfType([import_prop_types27.default.func, import_prop_types27.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types27.default.oneOfType([import_prop_types27.default.func, import_prop_types27.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types27.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime42.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'z'
   */
  axisDirection: import_prop_types28.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
   ...
   * The default depends on the chart.
   */
  direction: import_prop_types28.default.oneOf(["column", "row"]).isRequired,
  /**
   * Hide the first item of the legend, corresponding to the [-infinity, min] piece.
   * @default false
   */
  hideFirst: import_prop_types28.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types28.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
   ...
   */
  labelFormatter: import_prop_types28.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime43.jsxs)(React78.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime43.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime43.jsx)(ChartsAxisHighlightPath, {
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime44.jsx)("clipPath", {
    id,
...
true ? ChartsClipPath.propTypes = {
  ...
  offset: import_prop_types30.default.shape({
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime45.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
  ...
  return (0, import_jsx_runtime46.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime46.jsx)(Element2, _extends({
          id: seriesId,
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime47.jsx)(React82.Fragment, {
    children: xTicks.map(({
      formattedValue,
      offset: offset2
    }) => (0, import_jsx_runtime47.jsx)(GridLine, {
      y1: drawingArea.top,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(React83.Fragment, {
    children: yTicks.map(({
      formattedValue,
      offset: offset2
    }) => (0, import_jsx_runtime48.jsx)(GridLine, {
      y1: offset2,
      y2: offset2,
      x1: drawingArea.left,
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime49.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime49.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      drawingArea,
      classes
    }), horizontal && (0, import_jsx_runtime49.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
      drawingArea,
      classes
    })]
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(React85.Fragment, {});
}
...
var LineChart = React89.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
  });
  ...
  return (0, import_jsx_runtime54.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime54.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime54.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime54.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime54.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime54.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime54.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime54.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime54.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime54.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime54.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime54.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime54.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime54.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime54.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   * @default { x: 'line' }
   */
  axisHighlight: import_prop_types35.default.shape({
    x: import_prop_types35.default.oneOf(["band", "line", "none"]),
    y: import_prop_types35.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types35.default.oneOfType([import_prop_types35.default.arrayOf(import_prop_types35.default.string), import_prop_types35.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types35.default.arrayOf(import_prop_types35.default.object),
  desc: import_prop_types35.default.string,
  /**
   * If `true`, the charts will not listen to the mouse move event.
   * It might break interactive features, but will improve performance.
   * @default false
   */
  disableAxisListener: import_prop_types35.default.bool,
  /**
   * If `true`, render the line highlight item.
   */
  disableLineItemHighlight: import_prop_types35.default.bool,
  /**
   * If `true` marks will render `<circle />` instead of `<path />` and drop theme override for faster rendering.
   */
  experimentalMarkRendering: import_prop_types35.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types35.default.shape({
    horizontal: import_prop_types35.default.bool,
    vertical: import_prop_types35.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
  height: import_prop_types35.default.number,
  /**
   * The item currently highlighted. Turns highlighting into a controlled prop.
   */
  highlightedItem: import_prop_types35.default.shape({
    dataIndex: import_prop_types35.default.number,
    seriesId: import_prop_types35.default.oneOfType([import_prop_types35.default.number, import_prop_types35.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   ...
   */
  legend: import_prop_types35.default.shape({
    classes: import_prop_types35.default.object,
    direction: import_prop_types35.default.oneOf(["column", "row"]),
    hidden: import_prop_types35.default.bool,
    itemGap: import_prop_types35.default.number,
    itemMarkHeight: import_prop_types35.default.number,
    itemMarkWidth: import_prop_types35.default.number,
    labelStyle: import_prop_types35.default.object,
    markGap: import_prop_types35.default.number,
    onItemClick: import_prop_types35.default.func,
    padding: import_prop_types35.default.oneOfType([import_prop_types35.default.number, import_prop_types35.default.shape({
      bottom: import_prop_types35.default.number,
      left: import_prop_types35.default.number,
      right: import_prop_types35.default.number,
      top: import_prop_types35.default.number
    })]),
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types35.default.shape({
    bottom: import_prop_types35.default.number,
    left: import_prop_types35.default.number,
    right: import_prop_types35.default.number,
    top: import_prop_types35.default.number
   ...
   */
  onAreaClick: import_prop_types35.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   * @param {null | AxisData} data The data about the clicked axis and items associated with it.
   */
  onAxisClick: import_prop_types35.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   ...
   */
  onLineClick: import_prop_types35.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types35.default.func,
  /**
   * The chart will try to wait for the parent container to resolve its size
   * before it renders for the first time.
   *
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types35.default.bool,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   ...
   */
  tooltip: import_prop_types35.default.shape({
  ...
  viewBox: import_prop_types35.default.shape({
    height: import_prop_types35.default.number,
    width: import_prop_types35.default.number,
    x: import_prop_types35.default.number,
    y: import_prop_types35.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types35.default.arrayOf(import_prop_types35.default.shape({
    classes: import_prop_types35.default.object,
    colorMap: import_prop_types35.default.oneOfType([import_prop_types35.default.shape({
      colors: import_prop_types35.default.arrayOf(import_prop_types35.default.string).isRequired,
      type: import_prop_types35.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types35.default.string,
      values: import_prop_types35.default.arrayOf(import_prop_types35.default.oneOfType([import_prop_types35.default.instanceOf(Date), import_prop_types35.default.number, import_prop_types35.default.string]).isRequired)
    }), import_prop_types35.default.shape({
      color: import_prop_types35.default.oneOfType([import_prop_types35.default.arrayOf(import_prop_types35.default.string.isRequired), import_prop_types35.default.func]).isRequired,
      max: import_prop_types35.default.oneOfType([import_prop_types35.default.instanceOf(Date), import_prop_types35.default.number]),
      min: import_prop_types35.default.oneOfType([import_prop_types35.default.instanceOf(Date), import_prop_types35.default.number]),
      type: import_prop_types35.default.oneOf(["continuous"]).isRequired
    }), import_prop_types35.default.shape({
      colors: import_prop_types35.default.arrayOf(import_prop_types35.default.string).isRequired,
      thresholds: import_prop_types35.default.arrayOf(import_prop_types35.default.oneOfType([import_prop_types35.default.instanceOf(Date), import_prop_types35.default.number]).isRequired).isRequired,
      type: import_prop_types35.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types35.default.array,
    dataKey: import_prop_types35.default.string,
    disableLine: import_prop_types35.default.bool,
    disableTicks: import_prop_types35.default.bool,
    domainLimit: import_prop_types35.default.oneOfType([import_prop_types35.default.oneOf(["nice", "strict"]), import_prop_types35.default.func]),
    fill: import_prop_types35.default.string,
    hideTooltip: import_prop_types35.default.bool,
    id: import_prop_types35.default.oneOfType([import_prop_types35.default.number, import_prop_types35.default.string]),
    label: import_prop_types35.default.string,
    labelFontSize: import_prop_types35.default.number,
    labelStyle: import_prop_types35.default.object,
    max: import_prop_types35.default.oneOfType([import_prop_types35.default.instanceOf(Date), import_prop_types35.default.number]),
    min: import_prop_types35.default.oneOfType([import_prop_types35.default.instanceOf(Date), import_prop_types35.default.number]),
    position: import_prop_types35.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types35.default.bool,
    scaleType: import_prop_types35.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types35.default.object,
    slots: import_prop_types35.default.object,
    stroke: import_prop_types35.default.string,
    sx: import_prop_types35.default.oneOfType([import_prop_types35.default.arrayOf(import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object, import_prop_types35.default.bool])), import_prop_types35.default.func, import_prop_types35.default.object]),
    tickFontSize: import_prop_types35.default.number,
    tickInterval: import_prop_types35.default.oneOfType([import_prop_types35.default.oneOf(["auto"]), import_prop_types35.default.array, import_prop_types35.default.func]),
    tickLabelInterval: import_prop_types35.default.oneOfType([import_prop_types35.default.oneOf(["auto"]), import_prop_types35.default.func]),
    tickLabelPlacement: import_prop_types35.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types35.default.object,
    tickMaxStep: import_prop_types35.default.number,
    tickMinStep: import_prop_types35.default.number,
    tickNumber: import_prop_types35.default.number,
    tickPlacement: import_prop_types35.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types35.default.number,
    valueFormatter: import_prop_types35.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types35.default.arrayOf(import_prop_types35.default.shape({
    classes: import_prop_types35.default.object,
    colorMap: import_prop_types35.default.oneOfType([import_prop_types35.default.shape({
      colors: import_prop_types35.default.arrayOf(import_prop_types35.default.string).isRequired,
      type: import_prop_types35.default.oneOf(["ordinal"]).isRequired,
